...
class Bookdetail(LoginRequiredMixin,View):
    def get(self, request, id):
        ...
        return render(request, 'book/book_detail.html', {"book": book, 'review_form': review_form})
...
class EditReviewView(LoginRequiredMixin, View):
    def get(self, request, book_id, review_id):
        ...
        return render(request,"book/edit_review.html", {"book":book, "review":review, 'review_form':review_form})
